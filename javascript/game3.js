// import { E } from "./ExpantaNum.js";
// import * as E from './ExpantaNum.js';
/*悲催的 hard_shuati 只能被迫内载 Expantanum.js */
...
(function(globalScope) {
    ...
    P.tetrate = P.tetr = function(other, payload) {
        ...
        for (let i = 0, w = new ExpantaNum(ExpantaNum.E_MAX_SAFE_INTEGER); f !== 0 && r.lt(w) && i < 100; ++i) {
            if (f > 0) {
                r = t.pow(r);
                if (l.eq(r)) {
                    f = 0;
    ...
    P.arrow = function(arrows) {
        ...
        return function(other) {
            ...
            for (let i = 0, m = new ExpantaNum("10{" + (arrowsNum - 1) + "}" + MAX_SAFE_INTEGER); f !== 0 && r.lt(m) && i < 100; ++i) {
                if (f > 0) {
    ...
    P.expansion = function(other) {
        ...
        r = t;
        for (let i = 0; f !== 0 && r.lt(ExpantaNum.MAX_SAFE_INTEGER) && i < 100; ++i) {
            if (f > 0) {
                r = t.arrow(r)(t);
                --f;
            }
    ...
    P.toStringWithDecimalPlaces = function(places, applyToOpNums) {
        ...
        if (this.array.length >= 3 || this.array.length == 2 && this.array[1][0] >= 2) {
            for (let i = this.array.length - 1; !b && i >= 2; --i) {
                var e = this.array[i];
                var w = e[0];
                var x = e[1];
    ...
    P.toJSON = function() {
        if (ExpantaNum.serializeMode == ExpantaNum.JSON) {
            var a = [];
            for (let i = 0; i < this.array.length; ++i) a.push([this.array[i][0], this.array[i][1]]);
            return {
                array: a,
                layer: this.layer,
                sign: this.sign
    ...
    P.toHyperE = function() {
        ...
        var l = 1;
        for (let i = Math.ceil(this.getOperatorIndex(2)); i < this.array.length; ++i) {
    ...
    Q.fromObject = function(input) {
        ...
        /*var x=new ExpantaNum();
        x.array=[];
        for (let i=0;i<input.array.length;i++) x.array.push([input.array[i][0],input.array[i][1]]);
    ...
    P.clone = function() {
        ...
        var array = [];
        for (let i = 0; i < this.array.length; ++i) array.push([this.array[i][0], this.array[i][1]]);
        temp.array = array;
        temp.sign = this.sign;
    ...
    function clone(obj) {
        ...
        function ExpantaNum(input, input2) {
            ...
            if (typeof input == "number" && !(input2 instanceof Array)) {
                ...
                temp = [];
                for (let i = 0; i < input.array.length; ++i) temp.push([input.array[i][0], input.array[i][1]]);
                temp2 = input.sign;
                temp3 = input.layer;
...
const costs = [
    ...
    [E(0), E(10), E(100), E(1e3), E(1e4), E(1e6), E(1e9), E(1e12), E(1e15)],
    [E(0), E(10), E(100), E(1e3), E(1e4), E(1e6), E(1e9), E(1e12), E(1e15)],
    [E(0), E(10), E(100), E(1e3), E(1e4), E(1e6), E(1e9), E(1e12), E(1e15)],
    [E(0), E(10), E(100), E(1e3), E(1e4), E(1e6), E(1e9), E(1e12), E(1e15)],
    [E(0), E(1e7), E(1e12), E(1e18), E(1e30), E(1e45), E(1e75), E(1e155), E(1e250)],
    [E(0), E(1e7), E(1e12), E(1e18), E(1e30), E(1e45), E(1e75), E(1e155), E(1e250)],
    [E(0), E(1e7), E(1e12), E(1e18), E(1e30), E(1e45), E(1e75), E(1e155), E(1e250)],
    [E(0), E(1e7), E(1e12), E(1e18), E(1e30), E(1e45), E(1e75), E(1e155), E(1e250)],
    // [E(0), 16, 256, 65536, E(1e10), E(1e25), E(1e50), E(1e100), 1.79e308],
    // [E(0), E(1.0), E(10), E(1e3), E(1e5), E(1e7), E(0), E(0), 0]
];
const incs = [
    [E(0), E(0), E(0), E(0), E(0), E(0), E(0), E(0), E(0)],
    [E(0), E(100), E(1e3), E(1e4), E(1e5), E(1e6), E(1e8), E(1e10), E(1e12)],
    [E(0), E(100), E(1e3), E(1e4), E(1e5), E(1e6), E(1e8), E(1e10), E(1e12)],
    [E(0), E(100), E(1e3), E(1e4), E(1e5), E(1e6), E(1e8), E(1e10), E(1e12)],
    [E(0), E(100), E(1e3), E(1e4), E(1e5), E(1e6), E(1e8), E(1e10), E(1e12)],
    [E(0), E(10), E(100), E(1e3), E(1e4), E(1e5), E(1e6), E(1e7), E(1e8)],
    [E(0), E(10), E(100), E(1e3), E(1e4), E(1e5), E(1e6), E(1e7), E(1e8)],
    [E(0), E(10), E(100), E(1e3), E(1e4), E(1e5), E(1e6), E(1e7), E(1e8)],
    [E(0), E(10), E(100), E(1e3), E(1e4), E(1e5), E(1e6), E(1e7), E(1e8)],
    // [E(0), 16, 256, 65536, E(1e10), E(1e25), E(1e50), E(1e100), 1.79e308],
...
// function shorten(x) {
//     if (x < E(1e3)) return x;
//     else if (x < E(1e6)) return Math.round(x / E(1e3) * 100) / 100 + ' K';
//     else if (x < E(1e9)) return Math.round(x / E(1e6) * 100) / 100 + ' M';
//     else if (x < E(1e12)) return Math.round(x / E(1e9) * 100) / 100 + ' B';
//     else if (x < E(1e15)) return Math.round(x / E(1e12) * 100) / 100 + ' T';
//     else if (x < E(1e18)) return Math.round(x / E(1e15) * 100) / 100 + ' Qd';
//     else if (x < E(1e21)) return Math.round(x / E(1e18) * 100) / 100 + ' Qt';
//     else if (x < E(1e24)) return Math.round(x / E(1e21) * 100) / 100 + ' Sx';
//     else if (x < E(1e27)) return Math.round(x / E(1e24) * 100) / 100 + ' Sp';
//     else if (x < E(1e30)) return Math.round(x / E(1e27) * 100) / 100 + ' Oc';
//     else if (x < E(1e33)) return Math.round(x / E(1e30) * 100) / 100 + ' No';
//     else if (x < E(1e36)) return Math.round(x / E(1e33) * 100) / 100 + ' Dc';
//     return x;
// }

function shorten2(x) {
    if (x < E(1e4)) return x;
    else if (x < E(1e8)) return Math.round(x / E(1e4) * 100) / 100 + ' W';
    else if (x < E(1e12)) return Math.round(x / E(1e8) * 100) / 100 + ' E';
    else if (x < E(1e16)) return Math.round(x / E(1e12) * 100) / 100 + ' Z';
    else if (x < E(1e20)) return Math.round(x / E(1e16) * 100) / 100 + ' J';
    else if (x < E(1e24)) return Math.round(x / E(1e20) * 100) / 100 + ' H';
    return x;
}

function shorten0(x) {
    const y = new E(x);
    return shorten2(y.round().div(100));
}
//万、亿、兆、京、垓
function tostring(x) {
    var res = parseInt(x);
...
class Dimension {
    constructor(_name, _zhname, _point, _costs, _inc) {
        ...
        this.dims = [E(0), E(0.0), E(0.0), E(0.0), E(0.0), E(0.0), E(0.0), E(0.0), 0.0];
        this.boughts = [E(0), E(0.0), E(0.0), E(0.0), E(0.0), E(0.0), E(0.0), E(0.0), 0.0];
        this.muls = [E(0), E(1.0), E(1.0), E(1.0), E(1.0), E(1.0), E(1.0), E(1.0), E(1.0)];
        this.incs = _inc;
        this.costs = _costs;
        this.name = _name;
        this.zhname = _zhname;
    ...
    updatePoint() {
        var element = document.getElementById(this.name + "-Amount");
        element.innerHTML = '你有 ' + shorten0(this.point) + ' ' + this.zhname + '。';
    }
    updatePointPerSec() {
        var element = document.getElementById(this.name + "-PerSec")
    ...
    updateDimensions() {
        for (let i = 1; i <= 8; i++) {
            document.getElementById(this.flagshow(i)).innerHTML = '当前你拥有' + shorten0(this.dims[i]) + ' 个 ' + ' （实际上购买了 ' + shorten0(this.boughts[i]) + ' 个），乘数：' + shorten0(this.muls[i]);
        }
    }
    updateInter() {
        for (let i = 1; i < 8; i++) {
    ...
    updateCosts() {
        for (let i = 1; i <= 8; i++) {
            document.getElementById(this.flagcost(i)).innerHTML = '花费：' + shorten0(this.costs[i]);
        }
    }
    buy(x) {
        //购买第 x 维度
        var ly = lm; //玩梗，林愔是林明的妹妹
...
let AD = new Dimension("AM", "反物质", E(10),
    // [E(0), E(10), E(100), E(1e3), E(1e4), E(1e6), E(1e9), E(1e12), E(1e15)], 
    costs[1],
    // [E(0), E(100), E(1e3), E(1e4), E(1e5), E(1e6), E(1e8), E(1e10), E(1e12)]
    incs[1]);
...
setInterval(function() {
    AD.point += AD.dims[1] * AD.muls[1] * (1.0 / times);
    AD.updatePoint();
    AD.updatePointPerSec();
    AD.updateDimensions();
    AD.updateInter();
}, 1000.0 / times1);
...
function buytickspeed() {
    if (money >= tickSpeedCost) {
        ...
        AD.muls[1] *= 1.1;
        tickSpeedCost *= 2;
        document.getElementById("tickSpeedAmount").innerHTML = '当前倍率：' + shorten2(tickspeed) + '倍（实际购买数：' + shorten2(ticks) + '）';
        document.getElementById("tickSpeed").innerHTML = '花费: ' + shorten2(tickSpeedCost);
        AD.updatePoint();
        // AD.updateInterval();
    }
}

document.getElementById("tickSpeed").onclick = buytickspeed;
...
function reset_tier1() {
    AD.dims = [E(0), E(0.0), E(0.0), E(0.0), E(0.0), E(0.0), E(0.0), E(0.0), E(0.0)];
    AD.boughts = [E(0), E(0.0), E(0.0), E(0.0), E(0.0), E(0.0), E(0.0), E(0.0), E(0.0)];
    AD.muls = [E(0), E(1), E(1), E(1), E(1), E(1), E(1), E(1), E(1)];
    AD.costs = costs[1];
    tickspeed = 1;
    ticks = 0;
    tickSpeedCost = 1000;
...
document.getElementById("AM-DB").onclick = function() {
    ...
    for (let i = 1; i <= tmp1; i++) {
        AD.muls[2 * i - 1] = 2 ** (AD.db - i + 1);
        AD.muls[2 * i] = 2 ** (AD.db - i + 1);
    }
    for (let i = 1; i <= 4; i++) {
